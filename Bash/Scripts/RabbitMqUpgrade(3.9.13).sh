...
desired_erlang_version="v23.3.4.18" # Edit with the desired Erlang version (e.g. "v25.3.2.15")
new_erlang_version_install_file="erlang-23.3.4.18-1.el7.x86_64.rpm"
desired_rabbitmq_version="v3.9.13" # Edit with the desired RabbitMQ version (e.g. "v3.10.25")
new_rabbitmq_version_install_file="rabbitmq-server-3.9.13-1.el7.noarch.rpm"
