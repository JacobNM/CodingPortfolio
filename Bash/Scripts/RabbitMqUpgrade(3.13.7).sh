...
desired_rabbitmq_version="v3.13.7" # Edit with the desired RabbitMQ version (e.g. "v3.10.25")
new_rabbitmq_version_install_file="rabbitmq-server-3.13.7-1.el8.noarch.rpm"
