...
desired_erlang_version="v27.1.2" # Edit with the desired Erlang version (e.g. "v25.3.2.15")
new_erlang_version_install_file="erlang-27.1.2-1.el7.x86_64.rpm"
desired_rabbitmq_version="v4.0.4" # Edit with the desired RabbitMQ version (e.g. "v3.10.25")
new_rabbitmq_version_install_file="rabbitmq-server-4.0.4-1.el8.noarch.rpm"
